      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg">Manage incoming requests</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-3xl p-8 shadow-2xl backdrop-blur-xl">
            <h2 className="text-2xl font-bold mb-2">Telecaller Login</h2>
            ...
            <div className="mt-8 pt-8 border-t border-gray-800">
              ...
              <div className="bg-gray-800 rounded-lg p-3 space-y-2 text-xs">
                <p><span className="text-gray-400">Email:</span> <span className="text-purple-400 font-mono">telecaller@demo.com</span></p>
